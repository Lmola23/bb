...
Feliz cumpleaños al ángel que se enamoró de un simple mortal. Te amoooo.
  ...
  return (
    <div translate='no' className="app-container">
      {isStarted ? (
        <LoveCard message={longMessage.trim()} />
      ) : (
        <div className="heart-start-button" onClick={handleStart}>
          <svg viewBox="0 0 600 500">
            <path
              d="M300,150 C200,50 100,100 100,200 C100,300 300,450 300,450 C300,450 500,300 500,200 C500,100 400,50 300,150"
            />
            <text textAnchor="middle" x="300" y="220" className="heart-text-line">
              Para que nunca lo pierda,
            </text>
            <text textAnchor="middle" x="300" y="260" className="heart-text-line">
              se rompa, ni lo olvides.
            </text>
            <text textAnchor="middle" x="300" y="300" className="heart-text-line">
              Te amo con cada parte de mí.
            </text>
              <text textAnchor="middle" x="300" y="340" className="heart-text-line">
              Mi pequeña hermosa.
            </text>
          </svg>
        </div>
